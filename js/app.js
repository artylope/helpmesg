var phrases= {
  ...
  "tamil": {
    "language"  : "தமிழ்",
    "intro"     : "இந்த சிங்கப்பூர் அரசாங்கம் வழங்கிய உதவி போர்டல் உள்ளது.<br>நாம் உரிய அதிகாரிகளுக்கு உங்கள் கவலைகளை திருப்பி எங்கள் சிறந்த முயற்சி.",
    "select"    : "தேர்வு மொழி",
...
window.onload = function() {
  ...
  for (i = 0; i < lang.length; i++) {
    appendString += "<div>" + Object.values(phrases)[i].language + "</div>";
